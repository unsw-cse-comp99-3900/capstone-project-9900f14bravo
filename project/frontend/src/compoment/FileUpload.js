...
import { Box, Typography, Grid, RadioGroup, FormControlLabel, Radio, Select, MenuItem, IconButton, List, ListItem, ListItemText, Divider, Button } from '@mui/material';
        ...
        {uploadedFiles.filter(file => file.fileType === fileType).map((file, index) => (
          <React.Fragment key={index}>
            <ListItem>
              ...
              <IconButton edge="end" aria-label="delete" onClick={() => handleFileDelete(fileType, index)}>
                <Delete />
              </IconButton>
            </ListItem>
